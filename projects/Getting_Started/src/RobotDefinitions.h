...
#define GRAPPLER_SOLENOID_FWD_CHANNEL 4
#define GRAPPLER_SOLENOID_REV_CHANNEL 5
...
#define PULSES_PER_ROTATION 360.0

//AUTONOMOUS mode
#define BACKUP_INCHES 10.0
#define BACKUP_SPEED 0.35
