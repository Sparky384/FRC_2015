...
#define ELEVATOR_MOTOR_CHANNEL_A 5
#define ELEVATOR_MOTOR_CHANNEL_B 6

// DIO channels
#define LEFT_WHEEL_ENCODER_CHANNEL_A 0
#define LEFT_WHEEL_ENCODER_CHANNEL_B 1
#define RIGHT_WHEEL_ENCODER_CHANNEL_A 2
#define RIGHT_WHEEL_ENCODER_CHANNEL_B 3
